            ...
            <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-indigo-100/50 border border-slate-100 overflow-hidden">
                <div class="p-8 md:p-12">
                    ...
                    <div class="text-center mb-10">
                        <h2 class="text-3xl font-extrabold text-dark mb-3">Mulai Perjalanan Anda</h2>
                        <p class="text-slate-500">Buat akun untuk mengelola stok barang dengan sistem tercanggih.</p>
                    </div>
                    ...
                    <form action="{{ route('register')}}" method="POST" class="space-y-5">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <input type="text" name="name" id="name" placeholder="Masukkan nama lengkap Anda" class="w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl transition-all" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="••••••••" class="w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-2xl transition-all" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <button type="button" class="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 py-3.5 rounded-2xl font-semibold transition-all shadow-sm active:scale-95">
                            ...
                            <a href="{{ url('auth/google') }}">Daftar dengan Google</a>
                        </button>
                    </form>
                    ...
                    <p class="text-center mt-10 text-slate-600">
                        Sudah memiliki akun?
                        <a href="{{ route('login.show') }}" class="text-primary font-bold hover:underline decoration-2 underline-offset-4">Masuk di sini</a>
                    </p>
                </div>
            </div>
